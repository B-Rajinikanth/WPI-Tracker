    ...
    <section className="page active">
      <div className="page-header">
        ...
        <div className="page-actions">
          <button className="btn btn-primary btn-sm page-action-btn" onClick={() => { setForm({ name: "", username: "", password: "", role: "faculty", studentId: "" }); setFormErr(""); setShowCreateModal(true); }}>
            + Create User
          </button>
          <button className="btn btn-outline btn-sm page-action-btn" onClick={handleBulkStudents} disabled={bulkLoading}>
            {bulkLoading ? "⏳ Creating…" : "👥 Bulk Create Student Accounts"}
          </button>
        </div>
      </div>
          ...
          <div className="card" style={{ width: "100%", maxWidth: 480, padding: 28, margin: "0 16px" }}>
            ...
            <form onSubmit={handleCreate}>
              <div className="form-group" style={{ marginBottom: 12 }}>
                ...
                <input className="form-control" value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} placeholder="Dr. Priya Sharma" autoFocus required />
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                <div className="form-group">
                  <label className="form-label">Username</label>
                  <input className="form-control" value={form.username} onChange={e => setForm(p => ({ ...p, username: e.target.value }))} placeholder="priya.sharma" required />
                </div>
                <div className="form-group">
                  <label className="form-label">Password</label>
                  <input className="form-control" type="password" value={form.password} onChange={e => setForm(p => ({ ...p, password: e.target.value }))} placeholder="Min. 6 characters" required />
                </div>
              </div>
              <div className="form-group" style={{ marginBottom: 12 }}>
                <label className="form-label">Role</label>
                <select className="form-control" value={form.role} onChange={e => setForm(p => ({ ...p, role: e.target.value, studentId: "" }))}>
              ...
              {form.role === "student" && (
                <div className="form-group" style={{ marginBottom: 12 }}>
                  ...
                  <select className="form-control" value={form.studentId} onChange={e => setForm(p => ({ ...p, studentId: e.target.value }))}>
        ...
        <div style={{
          ...
          <div className="card" style={{ width: "100%", maxWidth: 380, padding: 28 }}>
            ...
            <div className="form-group">
              ...
              <input className="form-control" type="password" value={newPwd} onChange={e => setNewPwd(e.target.value)} placeholder="Min. 6 characters" autoFocus />
            </div>
